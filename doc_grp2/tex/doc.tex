...
\subsection{Konzept der Filter}
	...
	Dies sind kleine Module die aus Inputs, Logik und Outputs bestehen.
...
% Author: Felix Maaß
	...
	In unserer ``Live''-Konfiguration (siehe \autoref{img_LiveConfig}) wurde die Fahrbahnerkennung, die zur Übersichtlichkeit ihre eigene Konfiguration besitzt, eingebettet.
...
% Author: Felix Maaß
	...
	Um uns diesen Schritt zu vereinfachen, wurde eine abstrakte Klasse \texttt{cStdFilter} erstellt, die von der vorgegebenen Klasse \texttt{cFilter} erbt.
	...
	Der jedoch größte Gewinn besteht darin, dass Korrekturen und Implementationen weiterer Hilfsfunktionen so nur einmal an einer zentralen Stelle durchzuführen sind und dadurch eine höhere Übersichtlichkeit gewährleistet wird.
...
%TODO: Passivieren!! :)
	...
	Auf dem Weg zur Teststrecke wurde der geräumigen Flur vor Hörsaal 5 genutzten, um einen Test durchzuführen und auch diesen aufzuzeichnen. \\
	Zur Auswertung der Messdaten wurde der Wheel Speed Converter angepasst, um die Messwerte in eine CSV Datei zu schreiben. Diese CSV Datei haben wurde dann in einer Tabellenkalkulation bearbeitet. \\
