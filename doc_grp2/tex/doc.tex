...
\chapter{Motorregelung}	
	...
	Zuerst bestimmten wir wann die Beschleunigung beginnt und wann die Höchstgeschwindigkeit erreicht ist. Alle Werte vor und nach diesem Zeitraum wurden entfernt. Da wir nur die Aufnahme starten und stoppen konnten, liefen die Zeitstempel die ganze Zeit mit, so wurde zuerst die Zeit normalisiert. Als Höchstgeschwindigkeit wurde ein mittel der höchsten Geschwindigkeitswerte genommen.
