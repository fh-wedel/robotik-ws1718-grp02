...
Jedes Modul ist dabei eine \emph{C++}-Klasse, die die Initialisierung des Blocks und dessen In- und Outputpins übernimmt.
...
%https://en.wikipedia.org/wiki/Steering
	...
	Es existiert bereits eine vorgefertigte Implementation eines Filters, 
...
% TODO gut funktionierende Parameter in der BVA erklären/auflisten
