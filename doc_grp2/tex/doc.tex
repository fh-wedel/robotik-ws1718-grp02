...
%TODO: Passivieren!! :)
	...
	Über Wheel Encoder konnte die zurückgelegte Strecke und durch Ableiten nach der Zeit die Geschwindigkeit ermittelt werden. \\
	Im ADTF waren bereits zwei nutzbare Filter vorhanden:
	...
	Zuerst bestimmten wir wann die Beschleunigung begann und wann die Höchstgeschwindigkeit erreicht war. Alle Werte vor und nach diesem Zeitraum wurden entfernt. Da die Zeitstempel die ganze Zeit mitliefen, mussten zuerst die Zeiten auf den Anfang der Beschleunigung verschoben werden. Durch diese Anpassungen erhielten wir die Folgenden Graphen.\\
	\begin{figure}[ht]
		\centering
		\begin{tikzpicture}
