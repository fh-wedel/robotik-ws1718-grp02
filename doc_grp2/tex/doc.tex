...
\section{Mittels Radius}
	...
	Einige notwendige Vorkenntnisse sind bereits in \autoref{Steering_Angle_To_Servo} erläutert worden.
	...
	Analog zu \autoref{Steering_Angle_To_Servo} stellt $d$ die Spurweite und $l$ den Radstand dar.
...
\section{Übersicht}
	...
	\begin{figure}[ht]
		\centering
		\includegraphics[width=250pt,keepaspectratio]{assets/bvaFlowchart}
		\caption{Übersicht der Bildverarbeitung}
		\label{img_bvaFlowchart}
	\end{figure}
